    ...
    <div class="login-content">
        <div class="login-card">
            ...
            <div class="login-header">
                ...
                <img src="<?php echo e(asset('storage/logo-kemenag.png')); ?>" alt="Logo Kemenag" class="login-logo">
            ...
            <div class="login-body">
                <form method="POST" action="<?php echo e(route('login')); ?>">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select custom-select <?php $__errorArgs = ['nip'];
...
unset($__errorArgs, $__bag); ?>"
                            ...
                            <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($user->nip); ?>"
                                        data-name="<?php echo e($user->name); ?>"
                                        <?php echo e(old('nip') == $user->nip ? 'selected' : ''); ?>>
                                    <span class="nip-code"><?php echo e($user->nip); ?></span> - <span class="user-name"><?php echo e($user->name); ?></span>
                                </option>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="login-footer">
                <small class="text-muted">
                    © <?php echo e(date('Y')); ?> Kemenag Konawe Utara
                </small>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\e-lapak\resources\views/auth/login.blade.php ENDPATH**/ ?>