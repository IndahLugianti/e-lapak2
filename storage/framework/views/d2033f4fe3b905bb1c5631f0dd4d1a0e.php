                ...
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        ...
                        <div class="h5 mb-0 font-weight-bold text-gray-800" id="todayTickets">
                            <?php echo e(\App\Models\Ticket::whereDate('created_at', today())->count()); ?>
                ...
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        ...
                        <div class="h5 mb-0 font-weight-bold text-gray-800" id="todayCompleted">
                            <?php echo e(\App\Models\Ticket::whereDate('completed_at', today())->count()); ?>
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3 d-flex justify-content-between align-items-center">
                ...
                <?php if($recentTickets->count() > 0): ?>
                    <small style="color: white;"><?php echo e($recentTickets->count()); ?> tiket terbaru</small>
                <?php endif; ?>
            </div>
            <div class="card-body">
                <?php if($recentTickets->count() > 0): ?>
                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <small><?php echo e($ticket->created_at ? $ticket->created_at->format('d/m/Y H:i') : '-'); ?></small>
                                    </td>
                                    <td>
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <div class="d-grid gap-2">
                    ...
                    <a href="<?php echo e(route('tickets.index')); ?>" class="btn btn-outline-primary">
        ...
        function initCharts() {
            ...
            statusChart = new Chart(statusCtx, {
                ...
                data: {
                    ...
                    datasets: [{
                        data: [<?php echo e($pengajuanTickets); ?>, <?php echo e($prosesTickets); ?>, <?php echo e($selesaiTickets); ?>],
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\e-lapak\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>