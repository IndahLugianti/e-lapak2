...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'E-Lapak Konut'); ?></title>

    <!-- Favicon -->
    <link rel="icon" type="image/png" href="<?php echo e(asset('storage/logo-kemenag.png')); ?>">
    <link rel="shortcut icon" type="image/png" href="<?php echo e(asset('storage/logo-kemenag.png')); ?>">
    <link rel="apple-touch-icon" href="<?php echo e(asset('storage/logo-kemenag.png')); ?>">
...
<body>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <!-- Main Content -->
            <main class="<?php if(auth()->guard()->check()): ?> col-md-9 ms-sm-auto col-lg-10 <?php else: ?> col-12 <?php endif; ?> px-md-4 main-content">
                <!-- Alert Messages -->
...
<?php /**PATH C:\laragon\www\e-lapak\resources\views/layouts/app.blade.php ENDPATH**/ ?>