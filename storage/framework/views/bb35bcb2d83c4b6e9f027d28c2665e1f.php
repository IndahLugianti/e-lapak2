<?php $__env->startSection('title', 'Dashboard Approval'); ?>
...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    ...
    <div class="btn-toolbar mb-2 mb-md-0">
        <div class="btn-group me-2">
            <a href="<?php echo e(route('tickets.index')); ?>" class="btn btn-sm btn-primary">
            ...
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        ...
                        <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo e($needReviewTickets); ?></div>
                    </div>
                    <div class="col-auto">
            ...
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        ...
                        <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo e($approvedToday); ?></div>
                    </div>
                    <div class="col-auto">
            ...
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        ...
                        <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo e($avgResponseTime); ?>h</div>
                    </div>
                    <div class="col-auto">
    ...
    <div class="col-lg-8">
        <div class="card shadow mb-4">
            <div class="card-header py-3 d-flex justify-content-between align-items-center" style="background: linear-gradient(135deg, var(--primary-color) 0%, var(--primary-dark) 100%);">
                ...
                <?php if($reviewTickets->count() > 0): ?>
                    <small class="text-white-50"><?php echo e($reviewTickets->count()); ?> tiket menunggu</small>
                <?php endif; ?>
            </div>
            <div class="card-body">
                <?php if($reviewTickets->count() > 0): ?>
                    <div class="table-responsive">
                        <table class="table table-bordered table-hover">
                            ...
                            <tbody>
                                <?php $__currentLoopData = $reviewTickets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ticket): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <div class="fw-bold"><?php echo e(Str::limit($ticket->title, 30)); ?></div>
                                        <small class="text-muted"><?php echo e(Str::limit($ticket->description, 50)); ?></small>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <span class="badge bg-secondary"><?php echo e($ticket->serviceType->name); ?></span>
                                    ...
                                    <td>
                                        <div class="btn-group" role="group">
                                            ...
                                            <button type="button"
                                                    ...
                                                    onclick="approveTicket('<?php echo e($ticket->ticket_number); ?>', 'approve')"
                                                    title="Setujui">
                                                <i class="fas fa-check"></i>
                                            </button>
                                            <button type="button"
                                                    class="btn btn-sm btn-danger"
                                                    onclick="approveTicket('<?php echo e($ticket->ticket_number); ?>', 'reject')"
                                                    title="Tolak">
                    ...
                    <div class="text-center mt-3">
                        <a href="<?php echo e(route('tickets.index')); ?>" class="btn btn-primary">
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <?php if($recentActivity->count() > 0): ?>
                    <?php $__currentLoopData = $recentActivity; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ticket): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="d-flex align-items-center mb-3">
                            <div class="user-avatar me-3">
                                <i class="fas fa-ticket-alt"></i>
                            </div>
                            <div class="flex-grow-1">
                                <div class="small fw-bold"><?php echo e($ticket->ticket_number); ?></div>
                                <div class="text-muted small">
                                    Status: <span class="badge <?php echo e($ticket->getStatusBadgeClass()); ?>"><?php echo e($ticket->getStatusText()); ?></span>
                                </div>
                                <div class="text-muted small"><?php echo e($ticket->updated_at->diffForHumans()); ?></div>
                            </div>
                        </div>
            ...
            <div class="card-body">
                ...
                <div class="small">
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-7"><?php echo e(Auth::user()->position ?? 'Approval Manager'); ?></div>
                    </div>
                    <div class="row mb-2">
                        <div class="col-5 text-muted">Role:</div>
                        <div class="col-7">
                            <span class="badge bg-warning"><?php echo e(ucfirst(Auth::user()->role)); ?></span>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-5 text-muted">Last Login:</div>
                        <div class="col-7"><?php echo e(now()->format('d/m/Y H:i')); ?></div>
                    </div>
                </div>
            ...
            <div class="modal-body">
                ...
                <div class="row text-center">
                    <div class="col-6 mb-3">
                        <div class="h3" style="color: var(--primary-color);"><?php echo e($weeklyStats['this_week']); ?></div>
                        <small class="text-muted">Tiket Minggu Ini</small>
                    </div>
                    <div class="col-6 mb-3">
                        <div class="h3 text-secondary"><?php echo e($weeklyStats['last_week']); ?></div>
                        <small class="text-muted">Tiket Minggu Lalu</small>
                    </div>
                    <div class="col-6">
                        <div class="h3 text-success"><?php echo e($weeklyStats['approved_this_week']); ?></div>
                        <small class="text-muted">Approved Minggu Ini</small>
                    </div>
                    <div class="col-6">
                        <div class="h3 text-warning"><?php echo e($weeklyStats['pending_review']); ?></div>
...
setInterval(function() {
    const needReview = <?php echo e($needReviewTickets); ?>;
    if (needReview > 0) {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\e-lapak\resources\views/approval/dashboard.blade.php ENDPATH**/ ?>