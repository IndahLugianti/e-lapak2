<nav class="navbar navbar-expand-lg navbar-dark" style="background: linear-gradient(135deg, var(--primary-transparent) 0%, var(--primary-color) 40%, var(--primary-dark) 100%) !important;">
    <div class="container-fluid">
        <a class="navbar-brand d-flex align-items-center text-white" href="#">
            <img src="<?php echo e(asset('storage/logo-kemenag.png')); ?>"
                 alt="Logo Kemenag"
                 height="40"
                 class="me-3"
            ...
            <div class="nav-item dropdown" style="position: static;">
                <a class="nav-link dropdown-toggle user-dropdown-toggle d-flex align-items-center text-white" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                    ...
                    <div class="user-info d-none d-md-block">
                        <div class="user-name"><?php echo e(Str::limit(Auth::user()->name, 15)); ?></div>
                        <small class="user-role"><?php echo e(ucfirst(Auth::user()->role)); ?></small>
                    </div>
                ...
                <div class="dropdown-menu dropdown-menu-end modern-dropdown shadow-lg">
                    ...
                    <div class="dropdown-header-modern">
                        <div class="d-flex align-items-center p-3">
                            ...
                            <div class="flex-grow-1">
                                <div class="user-name-large"><?php echo e(Auth::user()->name); ?></div>
                                <div class="user-email-small"><?php echo e(Auth::user()->email ?? 'No email'); ?></div>
                            </div>
                        </div>
                        <div class="user-stats-row">
                            <div class="row text-center">
                                <div class="col-4">
                                    <div class="stat-number"><?php echo e(Auth::user()->createdTickets()->count()); ?></div>
                                    <div class="stat-label">Tiket</div>
                                </div>
                                <div class="col-4">
                                    <div class="stat-number"><?php echo e(ucfirst(Auth::user()->role)); ?></div>
                    ...
                    <div class="dropdown-body">
                        <div class="user-detail-item">
                            ...
                            <div class="detail-content">
                                ...
                                <div class="detail-value"><?php echo e(Auth::user()->nip); ?></div>
                            </div>
                        </div>
                        <div class="user-detail-item">
                            ...
                            <div class="detail-content">
                                ...
                                <div class="detail-value"><?php echo e(Str::limit(Auth::user()->department, 25)); ?></div>
                            </div>
                        </div>
                        <div class="user-detail-item">
                            ...
                            <div class="detail-content">
                                ...
                                <div class="detail-value"><?php echo e(Auth::user()->created_at->format('M Y')); ?></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="dropdown-actions">
                        <a href="<?php echo e(route('tickets.index')); ?>" class="dropdown-item-modern">
                            <i class="fas fa-ticket-alt"></i>
                            <span>Tiket Saya</span>
                        </a>
                        <?php if(!Auth::user()->isAdmin()): ?>
                        <a href="<?php echo e(route('tickets.create')); ?>" class="dropdown-item-modern">
                            <i class="fas fa-plus-circle"></i>
                            <span>Buat Tiket</span>
                        </a>
                        <?php endif; ?>
                        <a href="<?php echo e(route('profile.edit')); ?>" class="dropdown-item-modern">
...
<?php /**PATH C:\laragon\www\e-lapak\resources\views/layouts/header.blade.php ENDPATH**/ ?>