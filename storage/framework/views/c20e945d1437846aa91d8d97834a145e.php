       ...
       <div class="card shadow mb-4">
           ...
           <div class="card-body">
               <div class="mb-3">
                  ...
                  <?php if($admin_phone): ?>
                        <a href="https://wa.me/62<?php echo e(substr($admin_phone, 1)); ?>" target="_blank">
                            <?php echo e($admin_phone); ?>
               ...
               <div class="mb-3">
                   ...
                   <strong>Email:</strong><br>
                    ...
                    <?php if($admin_email): ?>
                        <a href="mailto:<?php echo e($admin_email); ?>">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\e-lapak\resources\views/pegawai/bantuan.blade.php ENDPATH**/ ?>