<?php $__env->startSection('title', 'Buat Tiket Baru'); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="row mb-4">
                        <div class="col-md-4">
                            ...
                            <div class="form-control-plaintext border rounded p-2 bg-light">
                                ...
                                <small class="text-muted">NIP: <?php echo e(Auth::user()->nip); ?></small>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <label class="form-label">
                    ...
                    <div class="d-flex justify-content-between">
                        <a href="<?php echo e(route('tickets.create')); ?>" class="btn btn-secondary">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\e-lapak\resources\views/tickets/create.blade.php ENDPATH**/ ?>